...
function E:ChangeBossVisibility(value)
	for i = 1, MAX_BOSS_FRAMES do
		if value then
			RegisterStateDriver(_G['ElvUF_Boss'..i], "visibility", "[@boss"..i..", help] show; hide")
		else
			UnregisterStateDriver(_G['ElvUF_Boss'..i], "visibility")
		end
	end
end
