...
WeakAurasSaved = {
	...
	["displays"] = {
		...
		["BfA: Nameplate Enemy Auras"] = {
			...
			["uid"] = "UYHcKKm(x3i",
			["url"] = "https://wago.io/SyNLm-ACX/45",
			["version"] = 45,
			["width"] = 30,
			["xOffset"] = 0,
			["yOffset"] = 0,
		...
		["쐐기 : 나에게 시전"] = {
			...
			["uid"] = "Ta1Qs)nAEp5",
			["url"] = "https://wago.io/uUwU71sI8/106",
			["version"] = 106,
			["width"] = 57,
			["xOffset"] = 0,
			["yOffset"] = 4320,
